    ...
    <div style="padding: 3em;">
      <div class="std">
        ...
        <div id="info-biller" class="std mt-5">
          ...
          <div style="max-width: 600px;">
            <strong>Met Biller betaal je zonder rente binnen 30, 60 of 90 dagen.</strong>
          </div>
          <div style="max-width: 600px;">
            <p>Wanneer u hiervoor kiest, zorgt Biller voor het gehele achteraf betalen proces. Het voordeel van Biller is dat u tot wel 90 dagen na levering kan betalen tot een bedrag van €10.000 inclusief BTW. Biller is speciaal gemaakt voor de zakelijke markt.</p>
          </div>
        </div>

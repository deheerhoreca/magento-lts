...
$aporder['billtoaddress']['isocountrycode'] = 'DE';
...
$aporder['shiptoaddress']['isocountrycode'] = 'DE';
...
// Profile number from installmentplans_lookup
$aporder['installment']['profileNo'] = '';

// Validate bank account by validate_bankaccount service
$aporder['installment']['bankCode'] = 'DEUTDEBB';

// Validate bank account by validate_bankaccount service
$aporder['installment']['bankAccount'] = 'DE89370400440532013000';

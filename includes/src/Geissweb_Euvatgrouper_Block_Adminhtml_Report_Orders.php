...
class Geissweb_Euvatgrouper_Block_Adminhtml_Report_Orders extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        $this->_blockGroup = 'euvatgrouper';
        $this->_controller = 'adminhtml_report_orders';
        $this->_headerText = Mage::helper('euvatgrouper')->__('EU VAT Orders Report');
        parent::__construct();

...
FC.OrderReview.prototype = {
    ...
    initialize: function(options) {
        ...
        // DHH -- @ see https://github.com/OpenMage/magento-lts/pull/1497
        // var selector = 'input:text, input:checkbox, input:radio, input:tel, select, textarea';
        var selector = 'input:text, input:checkbox, input:radio, input[type=tel], select, textarea';
        // END DHH
    ...
    getContent: function(from, to) {
        ...
        if ('payment-method' === from) {
            ...
            from.down('fieldset').select('li').each(function(li) {
                ...
                li.select('input:text, input[type=tel], select, textarea').each(function(el) {
                // END DHH

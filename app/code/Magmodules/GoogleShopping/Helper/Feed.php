...
class Feed extends AbstractHelper
{
    ...
    const XPATH_GENERATE_ENABLED = 'magmodules_googleshopping/generate/enabled';
    ...
    public function createFeed($config)
    {
        ...
        $header .= '<rss xmlns:g="http://base.google.com/ns/1.0" xmlns:c="http://base.google.com/ns/1.0" version="2.0" encoding="utf-8">' . PHP_EOL;
    ...
    public function getFeedSummary($time_start, $count, $limit)
    {
        ...
        $summary['date'] = $this->timezone->date($this->datetime->date())->format(\Magento\Framework\Stdlib\DateTime::DATETIME_PHP_FORMAT);
        return $summary;
    }

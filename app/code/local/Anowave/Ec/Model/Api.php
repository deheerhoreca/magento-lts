...
class Anowave_Ec_Model_Api
{
	...
	/**
	 * API requests per/second throttle
	 * 
	 * @var integer
	 */
	...
	public function __construct()
	{
		 ...
		 * Read throttle
		 * 
		 * @var integer $throttle
		 */
		$throttle = (int) Mage::getStoreConfig('ec/api/throttle');
	...
	public function create($entry)
	{
		if (method_exists($this, $entry))
		{
			...
			(
				trim(Mage::getStoreConfig('ec/api/google_gtm_account_id', $store)), trim(Mage::getStoreConfig('ec/api/google_gtm_container',$store))
			));
		}
	...
	{
		if (0 === (int) Mage::getStoreConfig('ec/api/use_built_in_credentials'))
		{
			$value = trim
			(
				Mage::getStoreConfig('ec/api/override_client_id')
			);
	...
	protected function getClientSecret()
	{
		if (0 === (int) Mage::getStoreConfig('ec/api/use_built_in_credentials'))
		{
			$value = trim
			(
				Mage::getStoreConfig('ec/api/override_client_secret')
			);

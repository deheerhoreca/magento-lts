...
class Amasty_Shopby_Block_Adminhtml_Filter_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_formScripts[] = "function saveAndMapped(value_id){ editForm.submit($('edit_form').action + 'mapped_value_url/' + value_id); }";
        $this->_formScripts[] = "function saveAndCreateMapped(){ editForm.submit($('edit_form').action + 'mapped_option/create') }";
    }

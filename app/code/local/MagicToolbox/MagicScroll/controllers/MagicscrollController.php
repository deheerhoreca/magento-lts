...
class MagicToolbox_MagicScroll_MagicscrollController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function addAction()
    {
        ...
        if ($data = $this->getRequest()->getPost()) {
            ...
            if (empty($oldModulesInstalled)) {
                $defaultValues = Mage::helper('magicscroll/params')->getDefaultValues();
            } else {
        ...
        if ($model->getId()) {
            ...
            if (!empty($oldModulesInstalled)) {
                $message = 'You have installed '.
                    ...
                    'Pease update it to the latest version to work correctly with this version of the Magic Scroll module.';
                Mage::getSingleton('adminhtml/session')->addError(Mage::helper('magicscroll')->__($message));
            }
    ...
    public function saveAction()
    {
        ...
        if ($post = $this->getRequest()->getPost()) {
            ...
            if (isset($post['magicscroll']['desktop']['customslideshowblock']['gallery'])) {
                $images = Mage::helper('core')->jsonDecode($post['magicscroll']['desktop']['customslideshowblock']['gallery']);
                $imagesToSave = array();
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('admin/magictoolbox/magicscroll');
    }

...
class MagicToolbox_MagicScroll_Helper_Image extends Mage_Core_Helper_Abstract
{
    ...
    public function init($imageFile=null)
    {
        ...
        $this->_cacheBaseDir = $this->_baseDir = Mage::getBaseDir('media').DS.'magictoolbox'.DS.'magicscroll';
    ...
    public function setBaseFile($file)
    {
        ...
        if (!$file || !file_exists($baseFile)) {
            throw new Exception(Mage::helper('magicscroll')->__('Image file was not found.'));
        }
    ...
    {
        $directory = Mage::getBaseDir('media').DS.'magictoolbox'.DS.'magicscroll'.DS.'cache'.DS;

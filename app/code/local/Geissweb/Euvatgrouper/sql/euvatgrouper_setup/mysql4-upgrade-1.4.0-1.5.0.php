...
if (version_compare(Mage::getVersion(), '1.4.2', '>=')) {
	Mage::getSingleton('eav/config')->getAttribute('customer_address', 'vat_trader_name')
...
if (version_compare(Mage::getVersion(), '1.4.2', '>=')) {
	Mage::getSingleton('eav/config')->getAttribute('customer_address', 'vat_trader_company_type')
        ->setData('used_in_forms', array('adminhtml_customer'))->save();
}
...
if (version_compare(Mage::getVersion(), '1.4.2', '>=')) {
	Mage::getSingleton('eav/config')->getAttribute('customer_address', 'vat_trader_address')
        ->setData('used_in_forms', array('adminhtml_customer'))->save();
}

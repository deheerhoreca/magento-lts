...
class Afterpay_Afterpay_Model_Api_Installmentplans_Lookup extends Afterpay_Afterpay_Model_Api_Abstract
{
    public function execute($requestData)
    {
        $this->_afterpay->setRest();
        $this->_afterpay->set_ordermanagement('installmentplans_lookup');

...
class Afterpay_Afterpay_Model_Api_Validate_Bankaccount extends Afterpay_Afterpay_Model_Api_Abstract
{
    public function execute($requestData)
    {
        $this->_afterpay->setRest();
        $this->_afterpay->set_ordermanagement('validate_bankaccount');

...
class Afterpay_Afterpay_Model_Request_Capture extends Afterpay_Afterpay_Model_Request_Abstract
{
    ...
    public function sendCaptureRequest()
    {
        ...
        //if no method has been set (no payment method could identify the chosen method) process the order as if it
        // had failed
        ...
        $this->_debugEmail .= "\n";
        //forms an array with all payment-independant variables (such as merchantkey, order id etc.) which are
        // required for the transaction request
        ...
        Mage::dispatchEvent(
            'afterpay_capture_request_addcustomvars',

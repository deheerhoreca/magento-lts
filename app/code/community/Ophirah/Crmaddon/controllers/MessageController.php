...
class Ophirah_Crmaddon_MessageController extends Mage_Core_Controller_Front_Action
{
    ...
    public function sendAction(){
        ...
        if($quote->getCustomerId() == $customerId){
            ...
            Mage::dispatchEvent('ophirah_crmaddon_send_before', ['crm_data' => $crmData]);
        ...
        //return to last page
        $this->_redirectUrl($this->_getRefererUrl());
        Mage::dispatchEvent('ophirah_crmaddon_send_after', ['crm_data' => $crmData]);
    }
    ...
    public function sendEmailWithTemplate($crmData, $default_template, $storeId, $template, $vars, $saveData)
    {
        ...
        $varsExtra = [
            ...
            'remark' => $remark,
            'link' => Mage::getUrl("qquoteadv/view/view/", ['id' => $qquote->getId()]),
            'adminlink' => $adminLink,
            'sender' => $sender,

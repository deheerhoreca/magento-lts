...
class Ophirah_Crmaddon_Block_Adminhtml_Crmaddon_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('custom_loadfield', 'custom_loadfield', [
            'label' => '',
        ...
        $fieldset = $form->addFieldset('template_fieldset',
            ['legend' => $helper->__('Message Information'),
                'class' => 'fieldset-wide'
            ]);
        ...
        $fieldset->addField('default', 'checkbox', [
            'label' => '',
        ...
        $fieldset->addField('custom_buttonsfield', 'custom_buttonsfield', [
            'label' => '',

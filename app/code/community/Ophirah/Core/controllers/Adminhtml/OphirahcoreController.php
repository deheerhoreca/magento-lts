...
//        //make sure that that ioncube is installed if this is not an open source package
...
//            }
        ...
        $success = $this->__('The required files are successfully loaded on the system.');

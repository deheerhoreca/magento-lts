...
if(!$installer->tableExists($installer->getTable('qquoteadv/product_attribute_group_allow'))){
    $table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('qquoteadv/product_attribute_group_allow', ['entity_id']),
            ['entity_id'])
        ->addIndex($installer->getIdxName('qquoteadv/product_attribute_group_allow', ['customer_group_id']),
            ['customer_group_id'])
        ->addIndex($installer->getIdxName('qquoteadv/product_attribute_group_allow', ['website_id']),
            ['website_id'])
...
if (!$attr->getId()) {
    ...
    $setup->addAttribute('catalog_product', 'group_allow_quotemode', [
        'group' => 'General',
        'input' => 'text',
        'type' => 'int',
    ...
    $setup->updateAttribute('catalog_product', 'group_allow_quotemode', [
        'frontend_input' => 'text',
        'backend_type' => 'int',

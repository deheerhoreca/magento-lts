...
if (!$installer->getConnection()->isTableExists($installer->getTable($product_downloadable))) {
    ...
    $table->addColumn('id', Varien_Db_Ddl_Table::TYPE_INTEGER, 10, [
            'auto_increment'    => true,
            'unsigned'          => true,
            'nullable'          => false,
            'primary'           => true,
    ...
    $table->addColumn('product_id', Varien_Db_Ddl_Table::TYPE_INTEGER, 10, [
            'unsigned'  => true,
            'primary'   => false,
            'nullable'  => false,
            'comment'   => 'Quoteadv Product Id']
    );
    $table->addColumn('link_id', Varien_Db_Ddl_Table::TYPE_INTEGER, 10, [
            'unsigned'  => true,
            'primary'   => false,
            'nullable'  => false,

...
class Ophirah_Qquoteadv_Model_Quotetotal extends Mage_Core_Model_Abstract
{
     ...
     * @var array
     */
    protected $_totalQuoteTotal = [];

    /**
     * @var array
     */
    protected $_collectedTotals = [];

    /**
     * @var array
     */
    protected $_totalExtra = [];
    ...
    public function allowedRuleTypes()
    {
        ...
        $ruleTypes = [Mage_SalesRule_Model_Rule::BY_PERCENT_ACTION,
                ...
                switch ($key){
                    case 'subtotal':
                        if (Mage::getStoreConfig('tax/cart_display/subtotal', $this->getQuoteStore()) == 3) {
                            $subtotal[] = ['label' => $total['title'] . $exclTax,
                            ...
                            $subtotal[] = ['label' => $total['title'] . $inclTax,
                            ...
                            $subtotal[] = ['label' => $total['title'] . $taxSet,
                                'value' => $total['value'],
                                'strong' => 1,
                                'code' => $key,
                                'order' => 40
                    ...
                    case 'grand_total':
                        if (Mage::getStoreConfig('tax/cart_display/grandtotal', $this->getQuoteStore()) == 0) {
                            $grandTotal[] = ['label' => $total['title'] . $exclTax,
                            ...
                            $grandTotal[] = ['label' => $total['title'] . $inclTax,
                                'value' => $total['value'],
                                'order' => 100,
                                'strong' => 1,
                                'code' => $key,

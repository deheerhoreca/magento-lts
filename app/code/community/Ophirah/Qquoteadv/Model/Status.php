...
class Ophirah_Qquoteadv_Model_Status extends Mage_Core_Model_Abstract
{
     ...
     * @return array
     */
    public static function getOptionArray($substatus = false)
    {
        ...
        Mage::dispatchEvent('qquoteadv_status_after_getoptionarray', ['options' => $statusOptions]);
     ...
     * @return array
     */
    public static function getGridOptionArray($substatus = false)
    {
        $helper = Mage::helper('qquoteadv');
        $gridOptionArray = [
            self::STATUS_REQUEST =>
        ...
        Mage::dispatchEvent('qquoteadv_status_after_getgridoptionarray', ['options' => $statusOptions]);
     ...
     * @return array
     */
    public static function getChangeOptionArray($substatus = false)
    {
        $helper = Mage::helper('qquoteadv');
        $changeOptionArray = [
            [
     ...
     * @return array
     */
    public static function statusAllowed()
    {
        $statusAllowed = [self::STATUS_BEGIN,
            self::STATUS_PROPOSAL_BEGIN,
            self::STATUS_REQUEST,
            self::STATUS_PROPOSAL,
            self::STATUS_PROPOSAL_SAVED,
     ...
     * @return array
     */
    public static function statusExpire()
    {

        $statusExpire = [self::STATUS_PROPOSAL,
            self::STATUS_PROPOSAL_SAVED,
            self::STATUS_AUTO_PROPOSAL
        ];

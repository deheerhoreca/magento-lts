...
class Ophirah_Qquoteadv_Model_Substatus extends Mage_Core_Model_Abstract
{
     ...
     * @return array
     */
    public static function substatuses()
    {
        $substatuses = [
     ...
     * @return array
     */
    public static function getChangeSubOptionArray($statusArray, $substatus = false)
    {
        $returnArray = [];
            ...
            foreach ($statusArray as $mainStatus) {
                ...
                if (isset($subStatusArray[$mainStatus['value']])){
                    foreach ($subStatusArray[$mainStatus['value']] as $k => $v) {
                        ...
                        $returnArray[] = ['value' => $mainStatus['value'] . self::EXPLODE_CHARACTER . $k, 'label' => $label];
                    }
                }
            }
        }
     ...
     * @return array
     */
    public static function getSubOptionArray($statusArray, $substatus = false)
    {
        $returnArray = [];
        $subStatusArray = self::_createSubStatusArray();
     ...
     * @return array
     */
    protected static function _createSubStatusArray()
    {
        $returnArray = [];
     ...
     * @return bool | array
     */
    public static function getParentStatus($subStatus)
    {
     ...
     * @return mixed
     */
    public static function getCurrentStatus($status, $substatus = null)
    {

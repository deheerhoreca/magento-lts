...
class Ophirah_Qquoteadv_Model_Qqadvproduct extends Mage_Core_Model_Abstract
{
    ...
    public function getCollection()
    {
        ...
        Mage::dispatchEvent('qquoteadv_product_collection_after', ['collection' => $collection]);
     ...
     * @param int / Ophirah_Qquoteadv_Model_Qqadvproduct    $quoteProductId
     ...
     *
     * @param int $id row id to be updated
     ...
     * @return  object|array with products and custom prices
     */
    public function getQuoteCustomPrices($quoteId)
    {
        ...
        foreach ($quoteProducts as $quoteProduct) {
            ...
            if (isset($attribute['super_attribute']) && $product->isConfigurable()) {
                ...
                $childInfoArray = ['entity_id', 'sku', 'allowed_to_quotemode'];
     ...
     * Therefor it is disabled in v5.2.3 and will be removed in a later version
     *
     * @param $price

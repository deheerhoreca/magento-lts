...
class Ophirah_Qquoteadv_Model_System_Config_Source_Followup
{
    ...
    {
        return [
            ['value' => 2, 'label'=>Mage::helper('qquoteadv')->__('Message Action')],
            ['value' => 1, 'label'=>Mage::helper('qquoteadv')->__('Today only')],
            ['value' => 0, 'label'=>Mage::helper('qquoteadv')->__('Today and Future')],
        ];
    }

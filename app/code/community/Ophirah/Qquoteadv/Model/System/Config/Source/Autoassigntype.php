...
class Ophirah_Qquoteadv_Model_System_Config_Source_Autoassigntype
{
    ...
    {
        return [
            ['value' => self::TYPE_NONE, 'label' => Mage::helper('qquoteadv')->__('None')],
            ['value' => self::TYPE_ROTATION, 'label' => Mage::helper('qquoteadv')->__('Rotate admin role')],
            ['value' => self::TYPE_ADMIN_LOGIN, 'label' => Mage::helper('qquoteadv')->__('Logged in admin user')],
            ['value' => self::TYPE_BOTH, 'label' => Mage::helper('qquoteadv')->__('Logged in admin user with rotate fallback')],
        ];
    }

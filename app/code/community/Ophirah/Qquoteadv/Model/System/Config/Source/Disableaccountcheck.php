...
class Ophirah_Qquoteadv_Model_System_Config_Source_Disableaccountcheck
{
    ...
    {
        return [
            ['value' => 0, 'label'=>Mage::helper('qquoteadv')->__('Require Quote submission with a known email address to login first.')],
            ['value' => 1, 'label'=>Mage::helper('qquoteadv')->__('Allow Quote submission with a known email address, without login first.')],
        ];
    }

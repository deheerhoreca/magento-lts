...
class Ophirah_Qquoteadv_Block_Qquoteadv_History extends Mage_Core_Block_Template
{
    ...
    {
        $this->getFilteredQuotes()->addFieldToFilter('created_at', [
            'from' => $this->getRequestData('from'),
            'to'   => $this->getRequestData('to'),
            'date' => true
        ]);
    ...
    {
        $this->getFilteredQuotes()->addFieldToFilter($filterField, [
        ...
        if (!empty($status)) {
            if ($status != Ophirah_Qquoteadv_Model_Status::STATUS_PROPOSAL_SAVED
                ...
                $this->getFilteredQuotes()->addFieldToFilter(
                    ...
                    [
                        ['like' => '%' . Ophirah_Qquoteadv_Model_Status::STATUS_PROPOSAL_SAVED . '%'],
                        ['like' => '%' . Ophirah_Qquoteadv_Model_Status::STATUS_PROPOSAL_BEGIN . '%']
                    ]
                );
            }
        }
    ...
    {
        return $this->getUrl('*/view/view', ['id' => $qquote->getId()]);
    ...
    {
        return $this->getUrl('*/*/track', ['order_id' => $qquote->getId()]);
    }
    ...
    {
        return $this->getUrl('*/*/reorder', ['order_id' => $qquote->getId()]);
    }

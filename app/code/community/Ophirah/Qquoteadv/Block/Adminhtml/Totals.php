...
class Ophirah_Qquoteadv_Block_Adminhtml_Totals extends Mage_Core_Block_Template
{
    ...
    protected function _initTotals()
    {
        ...
        // Get Sort Order
        $sortOrder = ['subtotal' => Mage::getStoreConfig('sales/totals_sort/subtotal', $storeId),
        ...
        if (Mage::getStoreConfig('qquoteadv_quote_configuration/proposal/adjustment', $storeId) == 1) {
            ...
            $this->_totals['quote_reduction'] = new Varien_Object([
    ...
    public function _addSubTotal($totals)
    {
        if ($this->_tax->displaySalesSubtotalExclTax($this->_storeId)){
            ...
            $this->_totals['subtotal_incl'] = new Varien_Object([
                'code' => 'subtotal',
                'strong' => true,
            ...
            $this->_totals['subtotal_excl'] = new Varien_Object([
                'code' => 'subtotal',
                'strong' => true,
                'value' => $totals->getSubtotal(),
                'label' => Mage::helper('tax')->__('Subtotal (Excl. Tax)')
    ...
    protected function _addSurcharge($totals){
        ...
        $this->_totals['surcharge'] = new Varien_Object([
            'code'  => 'surcharge',
    ...
    {
        $this->_totals['tax'] = new Varien_Object([
            'code' => 'tax',
            'field' => 'tax',
            'area' => 'footer',
    ...
    protected function _addGrandTotal($totals, $source)
    {
        if ($this->_tax->displaySalesTaxWithGrandTotal($this->_storeId)){
            ...
            $this->_totals['grand_total_excl'] = new Varien_Object([
                'code' => 'grand_total',
                'field' => 'grand_total',
                'strong' => true,
                'area' => 'footer',
            ...
            $this->_totals['grand_total_incl'] = new Varien_Object([
                'code' => 'grand_total',
                'field' => 'grand_total',
                'strong' => true,
                'area' => 'footer',
    ...
    protected function _addSubtotalOriginal(){
        // Subtotal (Original)
        $this->_totals['subtotal_original'] = new Varien_Object([
    ...
    protected function _addQuoteProfit(){
        $this->_totals['profit'] =  new Varien_Object([
     ...
     *
     * @param bool // for quote default tax
     * @return string
     */

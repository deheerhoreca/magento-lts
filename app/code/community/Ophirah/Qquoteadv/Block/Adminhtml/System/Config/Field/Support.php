...
class Ophirah_Qquoteadv_Block_Adminhtml_System_Config_Field_Support extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    public function renderInfo() {
        ...
        if ($this->getIonCubeVersion(false)) {
        ...
        if ($this->getOpenMageVersion()) {
            $html .= '<tr><td>OpenMage version: </td><td>' . $this->getOpenMageVersion() . '</td></tr>';
        }
     ...
     * @return string
     */
    public function getIonCubeVersion($message = true){
    ...
    public function renderCart2QuoteExpiryDate(){
        if($this->getCart2QuoteEdition() == 'Trial' || $this->getCart2QuoteEdition() == 'Enterprise (trial)'){

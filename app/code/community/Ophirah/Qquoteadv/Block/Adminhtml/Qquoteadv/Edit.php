    ...
    public function __construct()
    {
        ...
        $this->_formScripts[] = "
            ...
            function save(event){
                ...
                removeCrmData();
                editForm.submit($('edit_form').action =\"" . $this->getUrl('*/*/save', ['id' => $this->getRequest()->getParam('id')]) . "\");
            }
            ...
            function hold(event){
                ...
                removeCrmData();
                editForm.submit($('edit_form').action =\"" . $this->getUrl('*/*/save', ['id' => $this->getRequest()->getParam('id'), 'hold' => $hold]) . "\");
            }
            ...
            function edit(event){
                ...
                if (confirm('Are you sure you want to edit this quote? This will cancel this quote and create a new one.')) {
                    removeCrmData();
                    editForm.submit($('edit_form').action =\"" . $this->getUrl('*/*/editLockQuote', ['id' => $this->getRequest()->getParam('id')]) . "\");
                } else {
                    //Do nothing
                }
            }

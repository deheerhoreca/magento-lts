...
class Ophirah_CustomProducts_Model_Pdf_Product extends Ophirah_Qquoteadv_Model_Pdf_Qquote
{
    ...
    public function draw($unit, $page)
    {
        ...
        // Draw product image
        $prodImage = $productInformation->getFullpath(); //Fullpath without uppercase path
        ...
        $txt1 = $txt2 = $txt3 = [];
        // Setting first price
        if ($showPrice && isset($tierPrices[$unit->getQty()])) {
        ...
        $page = $this->getPdfModel()->drawLineBlocks($page, $drawItems, ['table_header' => true]);

<?php
class Psc_Paysafecash_Helper_PaymentClass extends Mage_Core_Helper_Abstract
{
    private $response;
    ...
    {
		$this->key = $this->getPaysafecash()->getApikey();
		
		if($this->getPaysafecash()->getTransactionMode()){

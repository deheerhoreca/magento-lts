<?php
class Psc_Paysafecash_Helper_RefundClass extends Mage_Core_Helper_Abstract
{
    private $response;
    ...
    public function __construct($key = "", $environment = "TEST")
    {
		...
		$this->key = $this->getPsc()->getApikey();
		
		if($this->getPsc()->getTransactionMode()){
     ...
     */
    public function captureRefund($payment_id, $amount, $currency, $merchantclientid, $psc_id, $correlation_id = "", $submerchant_id = "")
    {

...
//
// Usage: php text2dropdown.php attribute_code new_attribute_code
 ...
 * Run.
 *
 * @param  mixed $attrCodeOLD
 * @param  mixed $attrCodeNEW
 */
function launch($attrCodeOLD, $attrCodeNEW) {
  ...
  $_query           = "SELECT distinct value FROM catalog_product_entity_varchar
  WHERE attribute_id in (SELECT attribute_id FROM eav_attribute WHERE attribute_code='".$attrCodeOLD."') AND LENGTH(TRIM(value)) > 0";
